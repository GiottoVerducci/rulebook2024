...
You may come across cards which use certain templates (e.g. Govern the
Unaligned). For a better understanding, the most important templates are
listed below\
...
> **ADVANCED RULES**\
> Minions can equip cards which are already in play and controlled by the acting Methuselah.
> - **Cost when equipping from another minion you control:** None.

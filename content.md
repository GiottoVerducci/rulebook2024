...
must be played in that window. Wake effects can always be played during
action resolution and after action resolution. A reaction card that unlocks
a vampire but does not wake it is not considered as a wake effect and cannot
be played during the "as a card is played" window.
